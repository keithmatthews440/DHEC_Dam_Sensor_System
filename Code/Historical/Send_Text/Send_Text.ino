...
void setup() {
  ...
  */
  ...
  fona.endSMS();
//  char callerIDbuffer[32] = "+18034200090";
//  const char* text = "HelloWorld";
//  if(!fona.sendSMS(callerIDbuffer,text)) {
...
//  delay(100);
//  Serial.println(fonaSS.read());
//  fonaSS.println('AT+CMGS="+18645016496"');
//  delay(100);
//  fonaSS.println("Hello World ^Z");
//  delay(10000);
//  Serial.println(fonaSS.read());
//  delay(1000);
//  fonaSS.println('^Z');
