...
// Notice how we don't include the reset pin because it's reserved for emergencies on the LTE module!
  ...
  // For Adafruit IO:
  #define AIO_SERVER      "grovestream.com"
  #define AIO_SERVERPORT  1883
  #define AIO_USERNAME    "YOUR_AIO_USERNAME"
  #define AIO_KEY         "ee6372d6-ac76-3d4a-a9bc-8fcd6c3cdaeb"
  ...
  #define MQTT_SERVER      "cloudsocket.hologram.io"
  #define MQTT_SERVERPORT  9999
  #define MQTT_USERNAME    "735590"
  #define MQTT_KEY         "@b(e0O2d"
#endif
...
#if defined(PROTOCOL_MQTT_CLOUDMQTT)
